    ...
    <section id="home" className="home-section container">
      <div className="home-content">
        ...
        <p className="home-about">
          I build clean, carefully crafted web interfaces. While frontend is my
          strength, I’m comfortable working across the stack when needed to ship
          real products. I care less about titles and more about building things
