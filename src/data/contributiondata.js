...
const opensourcePRs = [
  {
    repoName: "More contributions coming soon",
    title: "Currently exploring good-first-issues and preparing new PRs",
    url: null,
  },
];
...
const contribution = [
  {
    ...
    description:
      "Contributed 6+ pull requests to open-source repositories, improving collaboration and Git workflow skills improving documentation, UI consistency, and code structure across multiple projects",
  ...
  },
  {
    ...
    description:
      "Actively contributing to open-source projects beyond Hacktoberfest. Exploring meaningful issues and preparing new pull requests.",
    linkdesc: "View PRs",
    isView: true,
    toggleText: {
